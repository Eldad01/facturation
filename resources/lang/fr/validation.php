...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné est apparu dans une fuite de données. Merci de choisir un :attribute différent.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'rccm' => 'RCCM',
        'country' => 'pays',
        'national_motto' => 'devise nationale',
        'delai_livraison' => 'délai de livraison',
        'quantite_minimum' => 'quantité minimale',
        'lignes' => 'lignes',
        'status' => 'statut',
    ],
