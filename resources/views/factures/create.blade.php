                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="type_document" 
                                    ...
                                    required>
                                <option value="pro-forma" {{ (old('type_document') ?? $type_document ?? 'pro-forma')=='pro-forma'?'selected':'' }}>Pro-forma</option>
                                <option value="recu" {{ (old('type_document') ?? $type_document ?? 'pro-forma')=='recu'?'selected':'' }}>Recu</option>
                            </select>
                            @error('type_document')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
