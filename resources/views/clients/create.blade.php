        ...
        <div class="modern-card">
            <div class="card-body">
                <form action="{{ route('clients.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="btn-group w-100" role="group">
                            <input type="radio" class="btn-check" name="type_client" id="type_particulier" value="particulier"
                                   {{ old('type_client', 'particulier') == 'particulier' ? 'checked' : '' }}
                            ...
                            <input type="radio" class="btn-check" name="type_client" id="type_entreprise" value="entreprise"
                                   {{ old('type_client') == 'entreprise' ? 'checked' : '' }}
                    ...
                    <div id="entreprise-fields" class="{{ old('type_client') == 'entreprise' ? '' : 'd-none' }}">
                        <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ifu" id="ifu" value="{{ old('ifu') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="boite_postale" id="boite_postale" value="{{ old('boite_postale') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="regime_imposition" id="regime_imposition" value="{{ old('regime_imposition') }}"
